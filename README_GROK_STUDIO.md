...
```text
Grok Studio Lab/grok_studio_data/logs/grok_studio.log
```
...
```text
~/Library/Application Support/Grok Studio Lab/V3/Instances/<download-instance>/
```
...
- Local basic image editor with TOAST UI, Mac system fonts, custom crop ratios, and non-destructive `_edit01` version saving
- Text-to-video
- Image-to-video
...
- Imagine-style media library and separate prompt library
- Sidebar hide/show
